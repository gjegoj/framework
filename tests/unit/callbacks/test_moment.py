...
@pytest.mark.parametrize(
    ("declared", "epoch"),
    [
        pytest.param(1.0, 10, id="all of it is the run's end"),
...
@pytest.mark.parametrize(
    ("declared", "step"),
    [
        pytest.param(1.0, 100, id="all of it is the last step"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(1.0, True, id="a beginning at the end: nothing would ever begin"),
