...
class TestResolveTarget:
    def test_imports_dotted_path(self) -> None:
        cls = resolve_target("tests.unit.core.test_instantiate._Widget")
...
class TestInstantiate:
    ...
    def test_target_escape_bypasses_registry(self) -> None:
        widget = instantiate(
            {"_target_": "tests.unit.core.test_instantiate._Widget", "color": "green"},
        )
        assert isinstance(widget, _Widget) and widget.color == "green"

    def test_target_escape_with_string_kwarg(self) -> None:
        widget = instantiate(
            {"_target_": "tests.unit.core.test_instantiate._Widget", "color": "blue"},
            _registry(),
        )
    ...
    def test_nested_target_in_list(self) -> None:
        result = instantiate(
            [
                {"_target_": "tests.unit.core.test_instantiate._Widget", "size": 7},
            ]
        )
