...
def test_mask_encoder_reads_class_indices_as_an_integer_array(tmp_path: Path) -> None:
    ...
    loaded = MaskTargetEncoder(classes={0: "a", 1: "b", 2: "c"}).load(path)
