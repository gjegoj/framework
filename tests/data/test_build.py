...
class TestPreprocessor:
    ...
    def test_preprocessing_is_required(self) -> None:
...
class TestDataModule:
    ...
    def test_a_custom_module_receives_the_same_facts(self, preprocessor: StandardPreprocessor) -> None:
        declared = component({"_target_": "tests.data.test_build.Recording", "flag": True})
...
def test_transforms_are_keyed_by_split_and_told_the_geometry() -> None:
    declared = {Stage.TRAIN: component({"_target_": "tests.data.test_build.Flip"})}
