...
VOCABULARY: Mapping[str, object] = {"task": "multiclass", "num_classes": CLASSES}
...
class TestContract:
    ...
    def test_the_metrics_a_kind_declares_score_what_that_kind_predicts(self, kind: str) -> None:
        ...
        metrics = build_metrics(declared, task.metric_kwargs())
...
class TestConfusionMatrix:
    ...
    def test_a_multilabel_matrix_is_refused_where_it_was_declared(self) -> None:
        ...
        with pytest.raises(ValueError, match="multilabel"):
            build_metrics({"confusion_matrix": "confusion_matrix"}, {"task": "multilabel", "num_labels": CLASSES})
